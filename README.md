...
**For mor details on how to use the web interface, see [Manual for the browser interface](https://github.com/ITxPT/DATA4PTTools/wiki/Manual-for-browser-based-interface)**
